...
export const skills: Array<{ title: string; imgSrc: string }> = [
  ...
  { title: 'Zustand', imgSrc: '/zustand.svg' },
  {
    title: 'NodeJs',
    imgSrc: '/node-js.svg',
  },
...
export const skillExp: Array<{ title: string; imgSrc: string }> = [
  ...
  { title: 'JavaScript', imgSrc: '/js.svg' },
  { title: 'NodeJs', imgSrc: '/node-js.svg' },
  { title: 'Socket.io', imgSrc: '/socket-io.svg' },
...
export const edvSkills: Array<{ title: string; imgSrc: string }> = [
  { title: 'HTML', imgSrc: '/html.svg' },
  { title: 'CSS', imgSrc: '/css.svg' },
  { title: 'TailwindCss', imgSrc: '/tailwindcss.svg' },
  { title: 'JavaScript', imgSrc: '/js.svg' },
  { title: 'TypeScript', imgSrc: '/typescript.svg' },
  { title: 'React', imgSrc: '/reactjs.svg' },
  { title: 'NodeJs', imgSrc: '/node-js.svg' },
  { title: 'NestJs', imgSrc: '/nestjs.svg' },
  { title: 'GraphQL', imgSrc: '/gql.svg' },
  { title: 'Jest', imgSrc: '/jest.svg' },
  { title: 'Webhooks', imgSrc: '/webhooks.svg' },
  { title: 'Payment Gateway', imgSrc: '/credit.svg' },
  { title: 'MongoDB', imgSrc: '/mongodb.svg' },
];

export const prodiosSkills: Array<{ title: string; imgSrc: string }> = [
  { title: 'HTML', imgSrc: '/html.svg' },
  { title: 'CSS', imgSrc: '/css.svg' },
  { title: 'TailwindCss', imgSrc: '/tailwindcss.svg' },
  { title: 'TypeScript', imgSrc: '/typescript.svg' },
  { title: 'React', imgSrc: '/reactjs.svg' },
  { title: 'NextJs', imgSrc: '/nextjs.svg' },
  { title: 'Zustand', imgSrc: '/zustand.svg' },
  { title: 'NodeJs', imgSrc: '/node-js.svg' },
  { title: 'NestJs', imgSrc: '/nestjs.svg' },
  { title: 'tRPC', imgSrc: '/trpc.svg' },
  { title: 'MongoDB', imgSrc: '/mongodb.svg' },
  { title: 'PostgreSQL', imgSrc: '/postgresql.svg' },
  { title: 'Prisma', imgSrc: '/prisma.svg' },
  { title: 'Tenstack Query', imgSrc: '/tenstack.svg' },
];
