  ...
  return (
    <Html>
      <Head>
        ...
        <Preview>Thank you for your inquiry. I’ll be in touch soon. || Souvik Hazra</Preview>
      </Head>
      <Body style={{ backgroundColor: '#f4f4f7', fontFamily: 'Arial, sans-serif' }}>
        ...
        >
          ...
          <Section>
            ...
            <Text style={{ fontSize: '16px', color: '#333333', lineHeight: '1.5' }}>
              I appreciate you reaching out and have received your message. I’ll review your query
              and will get back to you as soon as possible. You can expect a response at the email
              address provided: <strong>{email}</strong>.
            </Text>
            <Text style={{ fontSize: '16px', color: '#333333', lineHeight: '1.5' }}>
              Should you have any additional questions in the meantime, feel free to reach out.
            </Text>
          </Section>
